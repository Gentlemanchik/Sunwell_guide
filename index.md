...
1. **Не вся информация верна!** Т. к. всякие тактики писались в разное время разными людьми (играющие на разных классах и ролях и на разных пиратских серваках), то некоторые механики объяснены неправильно. Пуская "на пиратках так это и работало" или "я чёт помню, что вот так-то и так-то, как-то так", окей. В этих гайдах информация проверяется по логам и с записей стримов с ПТР.
